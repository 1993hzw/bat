...
//根据id获取评论
exports._get_comment_by_id=function(req,res,next){
    var id=req.query.id;
    if(!id||id<0) return res.json({state:-1});
...
//获取没有回复的评论
exports._get_comment_brief_noreplay=function(req,res,next){
    var off=req.query.offset;
    off=off||0;
...
//获取已回复的评论
exports._get_comment_brief_replayed=function(req,res,next){
    var off=req.query.offset;
    off=off||0;
...
//post 删除评论
exports._del_comment=function(req,res,next){
    var id=req.body.id;
    if(!id|id<0) return res.json({state:-1});
...
//回复评论
exports._replay= function (req,res,next) {
     var id=req.body.id;
